...
const emptyMediaBase = 'flex shrink-0 items-center justify-center mb-2 [&_svg]:pointer-events-none [&_svg]:shrink-0'
...
function EmptyMedia({
  ...
  return (
    <div
      ...
      className={cn(emptyMediaBase, emptyMediaVariants[variant], className)}
      {...props}
    />
  )
}
